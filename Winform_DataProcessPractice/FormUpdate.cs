...
namespace Winform_DataProcessPractice
{
    public partial class FormUpdate : Form
    {
        ...
        public string proName { get => txtName.Text; set { txtName.Text = value; } }
        public string proDesc { get => txtDesc.Text; set { txtDesc.Text = value; } }
        public double proPrice { get => Convert.ToDouble(txtPrice.Text); set { txtPrice.Text = value.ToString("0.00"); } }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                oldProduct.Name = txtName.Text;
                oldProduct.Description = txtDesc.Text;
                oldProduct.Price = Convert.ToDouble(txtPrice.Text);
